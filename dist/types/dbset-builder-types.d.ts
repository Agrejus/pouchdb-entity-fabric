...
export declare class IdBuilder<TDocumentType extends string, TEntity extends IDbRecord<TDocumentType>> implements IIdBuilderBase<TDocumentType, TEntity> {
    private _ids;
    private _keyType;
    get Ids(): EntityIdKeys<TDocumentType, TEntity>;
    get KeyType(): DbSetKeyType;
    add(key: EntityIdKey<TDocumentType, TEntity>): this;
    none(): ITerminateIdBuilder<TDocumentType, TEntity>;
    auto(): ITerminateIdBuilder<TDocumentType, TEntity>;
}
