...
export declare class DbSetBuilder<TDocumentType extends string, TEntity extends IDbRecord<TDocumentType>, TExtraExclusions extends string, TResult extends IDbSet<TDocumentType, TEntity, TExtraExclusions>> {
     ...
     * @returns DbSetBuilder
     */
    exclude<T extends string>(...exclusions: T[]): DbSetBuilder<TDocumentType, TEntity, TExtraExclusions | T, IDbSet<TDocumentType, TEntity, TExtraExclusions | T>>;
    map<T extends keyof TEntity>(propertyMap: PropertyMap<TDocumentType, TEntity, T>): DbSetBuilder<TDocumentType, TEntity, TExtraExclusions, TResult>;
    /**
